...
public class IntStreamOperations
{
	public static void main(String[] args)
	{
		...
		System.out.printf("%nEven values in displayed in sorted order: ");
		...
		IntStream.of(values).filter(value -> value % 2 == 1).map(value -> value * 10).sorted().forEach(value -> System.out.printf("%d ",  value));
		System.out.println();
